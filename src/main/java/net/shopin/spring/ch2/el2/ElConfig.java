...
@Configuration
@ComponentScan("net.shopin.spring.ch2.el2")
@PropertySource("classpath:net/shopin/spring/ch2/el2/test.properties")//7
public class ElConfig {
	...
	@Value("classpath:net/shopin/spring/ch2/el2/test.txt") //5
